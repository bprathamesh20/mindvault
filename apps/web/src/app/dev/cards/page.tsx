...
const FIXTURES: Card[] = [
  ...
  },
  {
    ...
    type: "link",
    status: "ready",
    url: "https://dribbble.com/collections/ui-refs",
  ...
  },
  {
    ...
    savedAt: now - 2 * D,
    thumbnailUrl: "https://avatars.githubusercontent.com/u/139895814?v=4&s=160",
    embedJson: {
      provider: "github",
      kind: "repo",
      owner: "shadcn-ui",
      ...
      forks: 6800,
      language: "TypeScript",
      topics: ["react", "components", "tailwindcss"],
    },
  },
  {
    id: "gh-2",
    type: "github",
    status: "ready",
    url: "https://github.com/get-convex/convex-backend/pull/412",
    title: "Speed up vector index backfill by batching embeddings",
    author: "sujayakar",
    sourceDomain: "github.com",
    preview: "Backfill now embeds 64 documents per request instead of one, cutting the full-index rebuild on the demo dataset from 41 minutes to 6.",
    tags: ["convex", "performance"],
    savedAt: now - 3 * D,
    thumbnailUrl: "https://avatars.githubusercontent.com/u/1263197?v=4&s=160",
    embedJson: {
      provider: "github",
      kind: "pull",
      owner: "get-convex",
  ...
  },
  {
    ...
    type: "github",
    status: "ready",
    url: "https://github.com/vercel/next.js/issues/71232",
    title: "Turbopack: HMR loses state when editing a server component that imports a client component",
    author: "leerob",
    sourceDomain: "github.com",
    tags: ["nextjs", "bug"],
    savedAt: now - 9 * D,
  ...
  },
  {
    ...
    type: "product",
    status: "ready",
    url: "https://www.altrarunning.com/en-us/products/mens-lone-peak-9-al0a85rg",
    title: "Men's Lone Peak 9",
    author: "Altra",
    sourceDomain: "altrarunning.com",
    summary:
      "Trail-running shoe with a roomy toe box, zero-drop platform and a sticky MaxTrac outsole.",
    tags: ["shoes", "trail", "wishlist"],
    savedAt: now - 4 * H,
    thumbnailUrl: pic("trailshoe", 800, 620),
    thumbWidth: 800,
    thumbHeight: 620,
    embedJson: {
      provider: "product",
      siteName: "Altra Running",
      brand: "Altra",
      price: 160,
      currency: "USD",
  ...
  },
  {
    ...
    type: "product",
    status: "ready",
    url: "https://www.myntra.com/trackpants/hrx/black-parachute/1",
    title: "Black Parachute Track Pants",
    author: "HRX",
    sourceDomain: "myntra.com",
    tags: ["clothing", "streetwear"],
    savedAt: now - 2 * D,
    thumbnailUrl: pic("pants", 700, 900),
    thumbWidth: 700,
    thumbHeight: 900,
    embedJson: {
      provider: "product",
  ...
  },
  {
    ...
    type: "product",
    status: "ready",
    url: "https://example.com/shop/desk-lamp",
    title: "Articulating Desk Lamp",
    sourceDomain: "example.com",
    summary: "No image could be pulled for this one.",
    tags: [],
    savedAt: now - 4 * D,
    embedJson: {
      provider: "product",
